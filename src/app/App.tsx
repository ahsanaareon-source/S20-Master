...
const PROTOTYPE_SESSION_KEY = 'majorWorksPrototypeAuthenticated';
            ...
            <div className="card border-0 shadow-lg" style={{ borderRadius: '20px' }}>
              <div className="card-body p-4 p-lg-5">
                ...
                <form onSubmit={handleAuthenticate}>
                  <div className="mb-3">
                    <label htmlFor="prototype-password" className="form-label fw-medium">
                      Password
                    </label>
                    <input
            ...
            {currentView === 'detail' && selectedWork && (
              <MajorWorksDetail 
                ...
                onEditModeChange={(isEdit) => {
                  ...
                  if (isEdit) {
                    setFormData(selectedWork.formData || null);
                    setIsFormDirty(false);
                  }
                }}
              />
